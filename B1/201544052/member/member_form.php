...
<script>
   ...
   function check_input()
   {
      ...
      if (!document.member_form.birth.value)
      {
       ...
       if (!document.member_form.hvy.value)
      {
          alert("취미를 입력하세요");    
          document.member_form.hvy.focus();
          return;
      }
   ...
   function reset_form()
   {
      ...
      document.member_form.hvy.value = "";
...
?>
  ...
  <div id="col2">
    ...
    <div id="form_join">
      ...
      <li><input type="text" name="birth"> (ex : 930324)</li>
      <li><input type="text" name="hvy">(ex : 책잃기,독서감상)</li>
