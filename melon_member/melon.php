...
<form  name="member_form" method="post" action="insert.php">
  ...
  <tr >
    ...
    <td><input type="text" name="id" size="15" maxlength="12" name="id">
    <button type="button" id= "check" onclick="check_id()">중복확인</button></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>
        <input type="text" size="4" name="phone1" maxlength="4"> -
